...
parser.add_argument('--face', type=str, help='Filepath of video/image that contains faces to use',
                    default='contents/input_video.mp4')
...
parser.add_argument('--pads', nargs='+', type=int, default=[0, 8, 0, 0], 
                    help='Padding (top, bottom, left, right). Please adjust to include chin at least')

parser.add_argument('--wav2lip_batch_size', type=int, help='Batch size for Wav2Lip model(s)', default=128)

parser.add_argument('--resize_factor', default=9, type=int, # default=1
...
def main():
    ...
    for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen,
        ...
        if i == 0:
            ...
            out = cv2.VideoWriter('tools/Wav2Lip/temp/result.avi',
    ...
    subprocess.check_call([
        ...
        "-i", "tools/Wav2Lip/temp/result.avi",
        "-i", args.audio,
        # "-c:v", "h264_nvenc",
        args.outfile, ### 체크
    ])
...
def do_load():
    ...
    checkpoint_path = 'tools/Wav2Lip/checkpoints/wav2lip_gan.pth'
    ...
    detector = RetinaFace(gpu_id=0, model_path="tools/Wav2Lip/checkpoints/mobilenet.pth", network="mobilenet")
