...
def trainer(cfg):
    ...
    return log, early_stop_epoch, history['tst_acc'][-1], tst_acc_max, acc_max_idx, history['trn_loss'][-1], history['tst_loss'][-1], tst_loss_min, loss_min_idxdddddaaaaaad
...
if __name__ == "__main__":
    ...
    set_mode = 'manytime' # onetime, manytime
    many_mode = 'day_20' # day_10, day_20, day_30, goodnight
