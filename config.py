...
config = {
  ...
  'model_cfg': {
    ...
    'model_list': [
        ...
        ['resnet101', models.ResNet101_Weights.IMAGENET1K_V1], # 11
        ['resnext50_32x4d', models.ResNeXt50_32X4D_Weights.IMAGENET1K_V1], # 12
        ['vgg11_bn', models.VGG11_BN_Weights.IMAGENET1K_V1], # 13
        ['vgg13_bn', models.VGG13_BN_Weights.IMAGENET1K_V1], # 14
        ['vgg16_bn', models.VGG16_BN_Weights.IMAGENET1K_V1], # 15
        ['vit_b_16', models.ViT_B_16_Weights.IMAGENET1K_V1], # 16
        ['swin_t', models.Swin_T_Weights.IMAGENET1K_V1], # 17
        ['custom', None], # 18
    ]
  },
