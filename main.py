...
video_change = "off"
# wav2lip inference
file_path = 'tools/Wav2Lip/inference.py'
  ...
  with st.container():
    ...
    if st.session_state.generate:
      ...
      if model_name == 'gemini-pro':
        ...
        tts.save("contents/input_audio.wav")
...
with col2:
  ...
  if video_change == "on":
    ...
    md =  f"""
              <video autoplay="true" muted="False" controls=False style="width: 100%">
    ...
    video_file = open('./contents/default.mp4', 'rb')
    video_bytes = video_file.read()
    video_base64 = base64.b64encode(video_bytes).decode('utf-8')
